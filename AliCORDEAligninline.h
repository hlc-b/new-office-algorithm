...
class AliACORDEAlign : public  TObject{
 ...
 public:
 inline AliACORDEAlign();
 inline AliACORDEAlign(/*Int_t reportloc,*/Int_t reportglob);
...
//  void CreateACORDEAlignObjs();
 ...
 // void SetDebug(Int_t debug){fDebug=debug;}
  ...
  //
 private:
 inline AliACORDEAlign(const AliACORDEAlign &align); // copy constructor
 inline AliACORDEAlign &operator = (const AliACORDEAlign &align); //assignment operator
